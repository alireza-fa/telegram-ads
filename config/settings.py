...
SECRET_KEY = 'django-insecure-r5f%faorv7#n%d8kgogmrmk6ci-ozj#4b-9@+m06e&%2vps(q5'
...
CELERY_WORKER_PREFETCH_MULTIPLIER = int(os.getenv("CELERY_PREFETCH_MULTIPLIER", 12))
